...
class ProductDetails extends React.Component {
  ...
  render () {
    ...
    let removeCents =
      this.state.productInfo[0].style_specs.original_price.length - 3
      ...
      <div className='overviewWrapper'>
        <div className='overviewProductDescriptionContainer'>
          <div className='overviewImageGallery'>
            <ProductGallery
              ...
              productMainInfo={this.props.productCatInfo}
          ...
          <div className='overviewInformationContainer'>
            <div className='overviewReviews'>
              <StarRating
                leftPercentage={this.state.leftPercentage}
                rightPercentage={this.state.rightPercentage}
              />
            </div>
            ...
            <div className='price'>
              $
              {this.state.productInfo[0].style_specs.original_price.slice(
                0,
                removeCents
              )}
            </div>
            <div className='overviewStyle'>
              <div>
                <strong>STYLE > </strong>{' '}
                {this.state.currentStyle.style_specs.name.toUpperCase()}
              </div>
        ...
        <div className='overviewProductDescriptionContainer'>
          ...
          <div className='overviewDescriptionChecklist'>
            <ul className='productFeatures'>{featuresBullets}</ul>
          </div>
        </div>
      </div>
    )
